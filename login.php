    ...
    <div class="content">
      <div class="container">
        <div class="row d-flex justify-content-center">
          ...
          <div class="card mt-5 col-lg-4 col-md-4 col-sm-12 col-12 bg-light">
                <div class="card-header text-center justify-content-center d-flex">
                  <div class="col-5 ">
                    ...
                    <a href="login.php" class="h1">
                      <img src="images/new.jpg" alt="logo" class="img-fluid shadow-sm img-circle">
                    </a>
                  </div>
                </div>
