            ...
            <div class="card card-outline card-primary">
              <div class="card-header text-center">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              ...
                              <textarea name="address" class="form-control" placeholder="Enter your address here..." id="" cols="30" rows="2"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                            <div class="form-group">
                              <span class="text-dark"><b>Examinee photo</b></span>
                              <div class="input-group">
                    ...
                    <!-- END ROW -->
                    <p>Already have an account? <a href="login.php" class="text-center">Login here!</a></p>
                </div>
