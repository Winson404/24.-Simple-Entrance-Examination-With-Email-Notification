	...
	if(isset($_POST['create_user'])) {
		...
		if(mysqli_num_rows($check_email)>0) {
	        ...
	        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        		...
        		$save = mysqli_query($conn, "INSERT INTO users (firstname, middlename, lastname, suffix, gender, civilstatus, religion, dob, age, address, email, contact, password, image, date_registered) VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$gender', '$civilstatus', '$religion', '$dob', '$age', '$address', '$email', '$contact', '$password', '$file', '$date_registered')");
