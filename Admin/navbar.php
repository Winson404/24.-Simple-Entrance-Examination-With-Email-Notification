    ...
    <div class="sidebar">
      ...
      <nav class="mt-3">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="category.php" class="nav-link"><i class="fa-sharp fa-solid fa-puzzle-piece"></i><p>&nbsp;&nbsp; Manage Category</p></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="results.php" class="nav-link"><i class="fa-solid fa-eye"></i><p>&nbsp;&nbsp; Examination results</p></a>
          </li>
