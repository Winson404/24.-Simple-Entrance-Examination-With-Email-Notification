<title>QUIZFORM  | Examinee account</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
                    ...
                    <form action="process_update.php" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3">
                          <span class="text-bold">Sex <span class="text-red">*</span></span>
              ...
              <div class="card-body p-4">
                    <form action="process_save.php" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3">
                          <span class="text-bold">Suffix <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <span class="text-bold">Nationality <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <span class="text-bold">Parent / Guardian's Name <span class="text-red">*</span></span>
                          <div class="form-group">
                            <input type="text" class="form-control" name="parentName" placeholder="Parent / Guardian's Name" required>
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <span class="text-bold">Parent / Guardian's Contact number <span class="text-red">*</span></span>
                          <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-text bg-white">+63</div>
                        ...
                        <div class="col-sm-6">
                          <span class="text-bold">Parent / Guardian's Email address <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                              <span><b>School last attended</b> <span class="text-red">*</span></span>
                              <input type="text" class="form-control"  placeholder="School last attended" name="schoolLastAttended" required>
                            </div>
                        </div>
                        <div class="col-MD-6">
                          <div class="form-group">
                            <span class="text-dark"><b>Upload receipt</b> <span class="text-red">*</span></span>
                              <div class="input-group">
