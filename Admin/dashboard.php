<title>QUIZFORM  | Dashboard</title>
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              <div class="inner">
                <?php
                  $questions = mysqli_query($conn, "SELECT quest_Id from questions");
                  $row_questions = mysqli_num_rows($questions);
                ?>
                <h3><?php echo $row_questions; ?></h3>
