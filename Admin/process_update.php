<?php 
	...
	if(isset($_POST['update_examinee'])) {
		...
		if($email == $get_email) {
			$update = mysqli_query($conn, "UPDATE users SET firstname='$firstname', middlename='$middlename', lastname='$lastname', suffix='$suffix', gender='$gender', civilstatus='$civilstatus', religion='$religion', dob='$dob', age='$age', address='$address', email='$email', contact='$contact' WHERE user_Id='$user_Id'");
		    if($update) {
		      $_SESSION['message'] = "System user has been updated!";
		      $_SESSION['text'] = "Updated successfully!";
		      $_SESSION['status'] = "success";
			...
			$exist = mysqli_query($conn, "SELECT * FROM users WHERE email='$email' ");
		  	if(mysqli_num_rows($exist) > 0) {
				...
				header("Location: examinee_add_update.php?page=".$user_Id);
	  			...
	  			$update = mysqli_query($conn, "UPDATE users SET firstname='$firstname', middlename='$middlename', lastname='$lastname', suffix='$suffix', gender='$gender', civilstatus='$civilstatus', religion='$religion', nationality='$nationality', dob='$dob', age='$age', address='$address', email='$email', contact='$contact' WHERE user_Id='$user_Id'");
			    if($update) {
			      $_SESSION['message'] = "Examinee record has been updated!";
			      $_SESSION['text'] = "Updated successfully!";
			      $_SESSION['status'] = "success";
				  header("Location: examinee_add_update.php?page=".$user_Id);
			    } else {
	...
	if(isset($_POST['update_profile'])) {
		...
		if($email == $get_email) {
			$save = mysqli_query($conn, "UPDATE users SET firstname='$firstname', middlename='$middlename', lastname='$lastname', suffix='$suffix', email='$email', contact='$contact', gender='$gender', dob='$dob', age='$age', civilstatus='$civilstatus', religion='$religion', address='$address' WHERE user_Id='$user_Id'");
		    if($save) {
