<title>QUIZFORM  | Administrator account</title>
<?php 
    include 'navbar.php'; 
    if(isset($_GET['page'])) {
      $page = $_GET['page'];
                    ...
                    <form action="process_update.php" method="POST" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-4 mb-3">
                            <span class="text-bold">Usertype <span class="text-red">*</span></span>
                        ...
                        <div class="col-sm-8">
                          <div class="form-group">
                            <span class="text-dark"><b>Upload image</b> <span class="text-red">*</span></span>
                              <div class="input-group">
                                ...
                                <div class="input-group-append">
                                  <span class="input-group-text">Upload <span class="text-red">*</span></span>
                                </div>
                              </div>
