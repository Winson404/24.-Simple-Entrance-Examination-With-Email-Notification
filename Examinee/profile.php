<title>QUIZFORM  | Examinee profile</title>
                ...
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="viewprofile">
                      <!-- <div class="form-group row">
                        <label for="Email" class="col-sm-2 col-form-label">Examinee category</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="Email" placeholder="Email" value="<?php echo $row['examineeCategory']; ?>" readonly>
                        </div>
                      </div> -->
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="Email" class="col-sm-2 col-form-label">Civil status</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="Email" placeholder="Email" value="<?php echo $row['civilstatus']; ?>" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="Email" class="col-sm-2 col-form-label">Religion</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="Email" placeholder="Email" value="<?php echo $row['religion']; ?>" readonly>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane" id="updateprofile">
                      ...
                      <div class="row">
                        <input type="hidden" class="form-control" id="Date of birth" placeholder="User Id" value="<?php echo $id; ?>" name="user_Id">
                        <div class="col-md-12">
                          <a class="h5 text-primary"><b>Basic information</b></a>
                          <div class="dropdown-divider"></div>
                        </div>
                        <div class="col-sm-6">
                          <span class="text-bold">First name <span class="text-red">*</span></span>
                        ...
                        <div class="col-sm-6">
                          <span class="text-bold">Middle name <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <span class="text-bold">Last name <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <span class="text-bold">Gender <span class="text-red">*</span></span>
                        ...
                        <div class="col-sm-6">
                          <span class="text-bold">Email <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <span class="text-bold">Contact number <span class="text-red">*</span></span>
                          <div class="form-group">
                            <div class="input-group">
                        ...
                        <div class="col-sm-5">
                          <span class="text-bold">Date of Birth <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-3">
                          <span class="text-bold">Age <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <span class="text-bold">Civil Status <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <span class="text-bold">Religion <span class="text-red">*</span></span>
                          <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          <span class="text-bold">Home address <span class="text-red">*</span></span>
                  ...
                  <div class="tab-pane" id="accountsecurity">
                    <form action="process_update.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="password" class="form-control" placeholder="Password" name="password" required id="new_password" minlength="8" maxlength="12">
                          <span class="text-red">Password must be at least 8 characters long</span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="cpassword" class="col-sm-2 col-form-label">Confirm password</label>
                        <div class="col-sm-10">
                          <input type="password" class="form-control" placeholder="Confirm password" name="cpassword" required id="new_cpassword" onkeyup="new_validate_password()" minlength="8" maxlength="12">
