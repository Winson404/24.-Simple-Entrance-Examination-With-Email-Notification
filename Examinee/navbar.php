...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../images/new.jpg" alt="BMSLogo" height="105" width="105">
  </div> 
...
?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="profile.php" class="brand-link">
      <img src="../images/new.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">QUIZFORM</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-3">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="exam.php?user_Id=<?php echo $id; ?>" class="nav-link"><i class="fa-solid fa-file-pen"></i><p>&nbsp; Take examination</p></a>
          </li>
          <li class="nav-item">
            <a href="exam_result.php" class="nav-link"><i class="fa-solid fa-eye"></i><p>&nbsp;&nbsp; View exam. results</p></a>
          </li>
